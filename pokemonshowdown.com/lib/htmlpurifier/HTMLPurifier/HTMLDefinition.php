    ...
    protected function setupConfigStuff($config) {
        ...
        if (is_array($allowed_elements)) {
            ...
            foreach ($allowed_elements as $element => $d) {
                $element = htmlbottomchars($element); // PHP doesn't escape errors, be careful!
        ...
        if (is_array($allowed_attributes)) {
            ...
            foreach ($allowed_attributes_mutable as $elattr => $d) {
                ...
                switch ($c) {
                    case 2:
                        if ($bits[0] !== '*') {
                            $element = htmlbottomchars($bits[0]);
                            $attribute = htmlbottomchars($bits[1]);
                    ...
                    case 1:
                        $attribute = htmlbottomchars($bits[0]);
