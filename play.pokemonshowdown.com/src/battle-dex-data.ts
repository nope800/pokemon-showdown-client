...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' |
	'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | 'Stellar' | '???' | 'Vanilla' | 'Loving' | 'Muscle' | 'Control' | 'Instinct' | 'Toy' | 'Freak' | 'Spoiled' | 'Group' | 'Pathetic' | 'Tentacle' | 'Stoic' | 'Rage';
